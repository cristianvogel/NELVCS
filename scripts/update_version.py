...
def main():
  ...
  plistpath = scriptpath + "/resources/NELVirtualControlSurface-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NELVirtualControlSurface-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NELVirtualControlSurface-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NELVirtualControlSurface-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NELVirtualControlSurface-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/NELVirtualControlSurface.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/NELVirtualControlSurface.iss",inplace=1):

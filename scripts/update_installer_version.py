...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NELVirtualControlSurface Demo Installer\n"
      else:
        line="OutputBaseFilename=NELVirtualControlSurface Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NELVirtualControlSurface Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NELVirtualControlSurface installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NELVirtualControlSurface Demo installer\n"
     else:
       line="SetupWindowTitle=NELVirtualControlSurface installer\n"

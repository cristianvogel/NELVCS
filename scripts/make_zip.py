...
def  main():
  ...
  installer = "\installer\NELVirtualControlSurface Installer.exe"
   
  if demo:
    installer = "\installer\NELVirtualControlSurface Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\NELVirtualControlSurface manual.pdf" 
  ]
  ...
  ZIPNAME = "NELVirtualControlSurface-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "NELVirtualControlSurface-v" + FULLVERSIONSTR + "-win-demo.zip"
